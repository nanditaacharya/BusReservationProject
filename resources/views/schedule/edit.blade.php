...
@section('content')
<h1 class="text-4xl font-extrabold text-blue-900">Edit Bus Schedule</h1>
...
<form action="{{ route('schedule.update', $schedule->id) }}" method="POST" class="space-y-6">
    ...
    <div class="mb-4">
        ...
        <input 
            ...
            class="w-full rounded-lg my-2 p-3 border @error('departure_time') border-red-500 @enderror"
        >
